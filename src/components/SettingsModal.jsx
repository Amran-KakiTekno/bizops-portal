      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
          ...
          <button 
            onClick={onClose}
            aria-label={t('close')}
            className="text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-white p-1 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Section 3: Workspace / About Info */}
        <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 text-xs space-y-1.5">
          <div className="flex justify-between text-slate-500 dark:text-slate-400">
            <span>{t('aboutWorkspace')}:</span>
            <span className="font-medium text-slate-800 dark:text-slate-200">KakiTekno Global Inc.</span>
          </div>
          <div className="flex justify-between text-slate-500 dark:text-slate-400">
            <span>{t('aboutDeploy')}:</span>
            <span className="font-mono text-indigo-600 dark:text-indigo-400">Cloudflare Pages Edge</span>
          </div>
          <div className="flex justify-between text-slate-500 dark:text-slate-400">
            <span>{t('aboutVersion')}:</span>
            <span className="font-mono text-slate-700 dark:text-slate-300">v2026.09 (Adaptive Shell)</span>
          </div>
        </div>
